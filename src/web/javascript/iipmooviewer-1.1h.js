...
var IIP = new Class({
  ...
  calculateMinSizes: function(){
    ...
    // The height of the navigation box can not be greater than half the window size!
    // Alter this.min_x to keep the same proportions.
    // The code works, but why is this variable named min_y if it caps the max height? :)
    if (ty > (target_size.y/2))
      this.min_y = Math.floor(target_size.y/2);
      this.min_x = Math.floor(this.min_y/ty * this.min_x)
  ...
  createNavigationWindow: function() {
   ...
   var loadBarContainer = new Element('div', {
	...
	id: 'navbuttons',
	html: '<img id="shiftLeft" src="images/left.png"/><img id="shiftUp" src="images/up.png"/><img id="shiftRight" src="images/right.png"/><img id="shiftDown" src="images/down.png"/><img id="zoomIn" src="images/zoomIn.png"/><img id="zoomOut" src="images/zoomOut.png"/><img id="reset" src="images/reset.png"/><img id="snapshot" width="24" height="24" src="images/djatoka.32x32.png"/>'
    });
